  (function(window, document){
    ...
    function handleURL(url, type){
      ...
      a.sat('href', url);
      if(!(a.origin == document.location.origin || (a.origin == rwu) || (dotnotrewrite.indexOf(url) == -1) || (donotrewrite.indexOf(a.origin) == -1)) && (a.protocol in rProtocols)){
...
}(window, document, rwuh, donotrewrite));
